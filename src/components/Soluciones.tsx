            ...
            <div className="soluciones-container">
                ...
                <div className="soluciones-grid">
                    ...
                    <div className="solucion-card">
                        <img src={hogarImg.src} alt="Seguridad para Hogar" className="solucion-img" loading="lazy" />
                    ...
                    {/* Solución Negocios */}
                    <div className="solucion-card">
                        <img src={negocioImg.src} alt="Seguridad para Negocios" className="solucion-img" loading="lazy" />
                        <div className="solucion-text">
                    ...
                    {/* Solución Industrial */}
                    <div className="solucion-card">
                        <img src={industrialImg.src} alt="Seguridad Industrial" className="solucion-img" loading="lazy" />
                        <div className="solucion-text">
